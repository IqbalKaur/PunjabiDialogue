...
namespace PunjabiDialogueTalk.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Content,CreatedAt,UserId,DialogueId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Content,CreatedAt,UserId,DialogueId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
